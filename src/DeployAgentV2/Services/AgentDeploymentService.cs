...
public class AgentDeploymentService
{
    ...
    public async Task<Dictionary<string, AgentReference>> CreateAllAgentsAsync(
        Dictionary<string, string>? placeholders = null)
    {
        ...
        return new Dictionary<string, AgentReference>(_createdAgents, StringComparer.OrdinalIgnoreCase);
    }

    private async Task<(List<Models.AgentDefinition> Agents, List<Models.ToolDefinition> Tools)> ParseDefinitionsAsync()
    {
    ...
    private void ValidateDefinitions(List<Models.AgentDefinition> agents, List<Models.ToolDefinition> tools)
    {
    ...
    private async Task<AgentReference> CreateAgentAsync(
        Models.AgentDefinition agentDef,
    ...
    private OpenAPIAgentTool? CreateOpenApiTool(Models.ToolDefinition toolDef)
    {
    ...
    public AgentReference? GetAgent(string agentName)
    {
